...
Navigator 1.6.2 now has final release metadata, passing automated checks and a
verified production VSIX built from clean public/private revisions. Publication
is left to the owner, including pushing the new hosted layout image before
Marketplace upload. See [Release preparation](marketplace-release.md) for the
